...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
  ...
  Widget _buildOrderItemRow(OrderModel item, bool isSmallScreen) {
    return Padding(
      ...
      child: Row(
        children: [
          if (item.items[0].productImage != null) // null 체크 추가
            Container(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: item.items[0].productImage ?? '',
                  fit: BoxFit.cover,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${NumberFormat('#,###').format(item.items[0].price.toInt())}원 · ${item.items[0].quantity}개',
                  style: TextStyle(color: Colors.grey.shade600, fontSize: 12),
                ),
              ],
            ),
          ...
          Text(
            '${NumberFormat('#,###').format(item.items[0].price.toInt())}원',
            style: const TextStyle(fontWeight: FontWeight.w500),
          ),
        ],
      ),
